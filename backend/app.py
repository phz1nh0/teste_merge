from flask import Flask, redirect, jsonify, request, render_template, send_from_directory
...
def create_app():
    ...
    def verificar_notificacoes():
        ...
        try:
            ...
            return jsonify({"sucesso": True, "mensagem": "Verificação de notificações concluída"})
